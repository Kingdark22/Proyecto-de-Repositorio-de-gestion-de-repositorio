                ...
                <td width="25%">
                    ...
                    <td width="25%">
                        ...
                        <select wire:model.live="seccionFilter" style="width: 95%;" <?php if(!$lapsoFilter || !$intranetDisponible): echo 'disabled'; endif; ?>>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $secciones->merge($seccionesDesdeGrupos)->unique('sec_codigo'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php $secLabel = trim($sec->sec_nombre ?? '') . (!empty($sec->pro_siglas) ? ' (' . trim($sec->pro_siglas) . ')' : ''); ?>
