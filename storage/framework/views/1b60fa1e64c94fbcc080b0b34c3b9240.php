<?php $__env->startSection('title', 'Registrar Tipo de Investigación'); ?>
<?php $__env->startSection('header', 'Registrar Tipo de Investigación'); ?>
...
<?php $__env->startSection('content'); ?>
    <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 20px; background-color: #FFF;">
        ...
        <form method="POST" action="<?php echo e(route('tipos-investigacion.store')); ?>" style="margin: 0;" onsubmit="return validarFormulario(this)">
            <?php echo csrf_field(); ?>
            <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top: 15px;">
                <tr>
                    <td width="30%"><b>Nombre del Tipo:</b></td>
                    <td width="70%">
                                <input name="nombre" type="text" value="<?php echo e(old('nombre')); ?>" style="width: 90%;" required oninput="validarNombre(this)" data-check-url="/tipos-investigacion/check-nombre">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <tr>
                    ...
                    <td width="70%">
                        <textarea name="descripcion" rows="4" style="width: 90%;"><?php echo e(old('descripcion')); ?></textarea>
                        <span class="obligatorio">*</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\tipo_investigacion\create.blade.php ENDPATH**/ ?>