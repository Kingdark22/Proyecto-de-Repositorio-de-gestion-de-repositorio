<div id="contenedor">
    ...
    <div id="centro_login">
        <h2 style="font-size: 22px; font-weight: bold; margin-top: 30px; margin-bottom: 30px;">
            Iniciar Sesión &mdash; Repositorio UPTP
        </h2>
...
<?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views/livewire/login.blade.php ENDPATH**/ ?>