...
<?php $__env->startSection('title', 'Registrar Tipo de Publicación'); ?>
<?php $__env->startSection('header', 'Registrar Tipo de Publicación'); ?>
...
<fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 20px; background-color: #FFF;">
    ...
    <form method="POST" action="<?php echo e(route('tipos-publicacion.store')); ?>" style="margin: 0;" onsubmit="return validarFormulario(this)">
        <?php echo csrf_field(); ?>
        ...
        <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top: 15px;">
            <tr>
                ...
                <td width="65%">
                                <input type="text" name="nombre" value="<?php echo e(old('nombre')); ?>" style="width: 90%;" required oninput="validarNombre(this)" data-check-url="/tipos-publicacion/check-nombre">
            ...
            <tr>
                ...
                <td width="65%">
                    <label style="display: flex; align-items: center; gap: 5px;">
                        <input type="checkbox" name="mencion_honorifica" value="1" <?php echo e(old('mencion_honorifica') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\tipo_publicacion\create.blade.php ENDPATH**/ ?>