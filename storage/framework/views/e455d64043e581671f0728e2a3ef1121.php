<?php $__env->startSection('title', 'Registrar Línea de Investigación'); ?>
<?php $__env->startSection('header', 'Registrar Línea de Investigación'); ?>
...
<?php $__env->startSection('content'); ?>
    <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 20px; background-color: #FFF;">
        ...
        <form method="POST" action="<?php echo e(route('lineas-investigacion.store')); ?>" style="margin: 0;" onsubmit="return validarFormulario(this)">
            <?php echo csrf_field(); ?>
            <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top: 15px;">
                <tr>
                    <td width="30%"><b>Nombre Línea de Inv.:</b></td>
                    <td width="70%">
                                <input name="nombre_investigacion" type="text" value="<?php echo e(old('nombre_investigacion')); ?>" maxlength="100" style="width: 90%;" required oninput="validarNombre(this)" data-check-url="/lineas-investigacion/check-nombre">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input name="area_de_investigacion" type="text" value="<?php echo e(old('area_de_investigacion')); ?>" maxlength="100" style="width: 90%;" required>
                        <span class="obligatorio">*</span>
                    ...
                    <td width="70%">
                        <select name="programa_id" style="width: 90%; padding: 2px;" required>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $programas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($p->id); ?>" <?php echo e(old('programa_id') == $p->id ? 'selected' : ''); ?>><?php echo e($p->siglas); ?> - <?php echo e($p->nombre); ?></option>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <tr>
                    ...
                    <td width="70%">
                        <textarea name="descripcion" rows="3" maxlength="500" style="width: 90%;" required><?php echo e(old('descripcion')); ?></textarea>
                        <span class="obligatorio">*</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\lineas\create.blade.php ENDPATH**/ ?>