...
<?php $__env->startSection('title', 'Metodologías de Investigación'); ?>
<?php $__env->startSection('header', 'Gestión de Metodologías de Investigación'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; gap: 20px;">
        <form method="GET" action="<?php echo e(route('metodologia-investigacion')); ?>" style="display: inline-flex; align-items: center; gap: 6px;" id="searchForm">
            <b>Buscar Metodología:</b>
            <input name="search" type="text" value="<?php echo e($search); ?>" style="width: 400px; padding: 4px 6px; border-radius: 4px; border: 1px solid #999;" placeholder="Nombre de la metodología..." oninput="buscarConDebounce(this)">
        </form>

        <button type="button" onclick="window.location='<?php echo e(route('metodologia-investigacion.create')); ?>'" class="cm-btn cm-btn-success cm-btn-sm">
            ...
            <table width="100%" border="1" cellpadding="4" cellspacing="0"
                ...
                <thead>
                    <tr style="background-color: #8bb2b7; color: #000; text-align: center; font-weight: bold;">
                        <th style="padding: 5px;" width="25%">Metodología</th>
                        ...
                        <tr
                            ...
                            <td align="center">
                                <div style="display: inline-flex; align-items: center; gap: 4px;">
                                    <button type="button" onclick="window.location='<?php echo e(route('metodologia-investigacion.edit', $item->id)); ?>'" title="Editar"
                                        class="cm-btn cm-btn-secondary cm-btn-sm">Editar</button>

                                    <button type="button" data-ajax-toggle="<?php echo e(route('metodologia-investigacion.toggle', $item->id)); ?>" data-toggle-name="<?php echo e($item->nombre); ?>"
                                        title="<?php echo e($item->estado_logico ? 'Deshabilitar' : 'Habilitar'); ?>"
                                        class="cm-btn cm-btn-warning cm-btn-sm"><?php echo e($item->estado_logico ? 'Deshabilitar' : 'Habilitar'); ?></button>

                                    <form action="<?php echo e(route('metodologia-investigacion.destroy', $item->id)); ?>" method="POST" style="display: inline;" >
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\metodologia_investigacion\index.blade.php ENDPATH**/ ?>