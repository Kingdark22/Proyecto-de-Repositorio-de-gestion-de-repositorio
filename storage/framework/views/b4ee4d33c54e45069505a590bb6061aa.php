...
<head>
    <meta charset="UTF-8">
    <title>SOLVENCIA OFICIAL - <?php echo e($folio); ?></title>
    <style>
        @page { margin: 25mm; }
...
<body>
    ...
    <div class="footer">
        Sistema de Repositorio de <?php echo e($tipoProyecto == 'Proyecto Sociotecnológico' ? 'Proyectos Sociotecnológicos' : 'Proyectos Sociocomunitarios'); ?> — Folio: <?php echo e($folio); ?>
