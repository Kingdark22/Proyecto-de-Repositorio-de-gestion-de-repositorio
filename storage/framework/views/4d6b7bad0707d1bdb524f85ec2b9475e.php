...
<?php endif; ?>
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($_flashMsg || $_flashSuccess || $_flashErr || $_flashErr2): ?>
        <script>
        (function() {
            var type = 'info', msg = '';
            <?php if($_flashMsg): ?>
            ...
            <?php elseif($_flashSuccess): ?>
                type = 'success';
                msg = '<?php echo e(addslashes($_flashSuccess)); ?>';
