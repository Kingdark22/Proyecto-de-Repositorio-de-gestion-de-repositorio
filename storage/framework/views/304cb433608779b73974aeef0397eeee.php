...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
    <div data-flash-msg style="background: #d4edda; color: #155724; padding: 12px 18px; border-radius: 6px; margin-bottom: 16px; border: 1px solid #c3e6cb; font-weight: bold;"><?php echo e(session('success')); ?></div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
    <div data-flash-msg style="background: #f8d7da; color: #721c24; padding: 12px 18px; border-radius: 6px; margin-bottom: 16px; border: 1px solid #f5c6cb; font-weight: bold;"><?php echo e(session('error')); ?></div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>

<div style="margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; gap: 20px;">
    <form method="GET" action="<?php echo e(route('tipos-publicacion')); ?>" style="display:inline;" id="searchForm">
        <b>Buscar Tipo:</b>
        <input type="text" name="search" value="<?php echo e($search); ?>" style="width: 500px; padding: 4px 6px; border-radius: 4px; border: 1px solid #999;" placeholder="Nombre del tipo..." oninput="buscarConDebounce(this)">
    </form>

    <button type="button" onclick="window.location='<?php echo e(route('tipos-publicacion.create')); ?>'" class="cm-btn cm-btn-success cm-btn-sm" style="margin-right: 30px;">Registrar Tipo</button>
</div>
...
<fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 10px; margin: 0;">
        ...
        <tbody class="Texto">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <tr style="background-color: <?php echo e($loop->iteration % 2 == 0 ? '#E0E0E0' : '#FFFFFF'); ?>; <?php echo e(!$item->estado_logico ? 'color: #888;' : 'color: #000;'); ?>">
                    <td align="center" style="font-weight: bold; padding: 5px;"><?php echo e($item->nombre); ?></td>
                    <td align="center">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->mencion_honorifica): ?>
                    ...
                    <td align="center">
                        <div style="display: inline-flex; align-items: center; gap: 4px;">
                            <button type="button" onclick="window.location='<?php echo e(route('tipos-publicacion.edit', $item->id)); ?>'" title="Editar" class="cm-btn cm-btn-secondary cm-btn-sm">Editar</button>
                            <button type="button" data-ajax-toggle="<?php echo e(route('tipos-publicacion.toggle', $item->id)); ?>" data-toggle-name="<?php echo e($item->nombre); ?>" title="<?php echo e($item->estado_logico ? 'Deshabilitar' : 'Habilitar'); ?>" class="cm-btn cm-btn-warning cm-btn-sm"><?php echo e($item->estado_logico ? 'Deshabilitar' : 'Habilitar'); ?></button>
                            <form method="POST" action="<?php echo e(route('tipos-publicacion.destroy', $item->id)); ?>" style="display:inline;" >
                                <?php echo csrf_field(); ?>
    ...
    <div style="margin-top: 10px;"><?php echo e($items->links()); ?></div>
</fieldset>
</div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\tipo_publicacion\index.blade.php ENDPATH**/ ?>