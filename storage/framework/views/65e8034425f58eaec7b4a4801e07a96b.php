...
<aside class="legacy-sidebar" id="menu_lateral">
            ...
            <li>
                ...
                <div class="legacy-submenu">
                    ...
                    <a href="<?php echo e(route('proyectos.gestion')); ?>"
                        class="<?php echo e(request()->routeIs('proyectos.gestion', 'proyectos.crear', 'validaciones.index') ? 'active-sub' : ''); ?>">Depósito de proyectos</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </li>
    ...
    <div id="notificacionesContainer" class="notif-container">
        <button type="button" onclick="toggleNotificaciones()" class="notif-bell-btn <?php echo e($notificacionesCount > 0 ? 'has-notifications' : ''); ?>" id="notifBellBtn" title="Notificaciones">
        ...
        <div id="notificacionesDropdown" class="notif-dropdown" style="display: none;">
            <div class="notif-header">
                ...
                <span class="notif-header-count"><?php echo e($notificacionesCount); ?></span>
            </div>
            <div class="notif-list">
                ...
                ?>
                <a href="<?php echo e($notif['url']); ?>" class="notif-item <?php echo e($itemType); ?>" data-dismiss-id="<?php echo e($dismissId); ?>">
                    ...
                    <div class="notif-item-text">
                        ...
                        <div class="notif-item-msg"><?php echo e($notif['mensaje']); ?></div>
                    </div>
                    <button type="button" class="notif-dismiss" onclick="event.preventDefault();event.stopPropagation();dismissNotif('<?php echo e($dismissId); ?>')" title="Descartar notificación">&times;</button>
                </a>
