...
<?php $__env->startSection('content'); ?>
    ...
    <div style="margin-bottom: 15px; display: flex; align-items: center;">
        <form method="GET" action="<?php echo e(route('tipos-investigacion')); ?>" style="display: contents;" id="searchForm">
            <div>
                <b>Buscar Tipo:</b>
                <input name="search" type="text" value="<?php echo e($search); ?>" style="width: 400px; padding: 4px 6px; border-radius: 4px; border: 1px solid #999;" placeholder="Nombre del tipo..." oninput="buscarConDebounce(this)">
            </div>
        </form>
                        ...
                        <tr
                            ...
                            <td align="center">
                                <div style="display: inline-flex; align-items: center; gap: 4px;">
                                    ...
                                    <button type="button" data-ajax-toggle="<?php echo e(route('tipos-investigacion.toggle', $item->id)); ?>" data-toggle-name="<?php echo e($item->nombre); ?>" title="<?php echo e($item->estado_logico ? 'Deshabilitar' : 'Habilitar'); ?>"
                                        class="cm-btn cm-btn-warning cm-btn-sm"><?php echo e($item->estado_logico ? 'Deshabilitar' : 'Habilitar'); ?></button>
                                    <form method="POST" action="<?php echo e(route('tipos-investigacion.destroy', $item->id)); ?>" style="display:inline;" >
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\tipo_investigacion\index.blade.php ENDPATH**/ ?>