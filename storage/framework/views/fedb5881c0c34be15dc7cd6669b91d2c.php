...
<?php $__env->startSection('content'); ?>
    ...
    <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 10px; margin-bottom: 20px;">
        ...
        <table width="100%" border="0" cellpadding="8" cellspacing="0" style="font-size: 11px;">
            <tr>
                <td width="65%">
                    <form method="GET" action="<?php echo e(route('comunidades.index')); ?>" id="searchForm" style="display: flex; align-items: center; gap: 8px; margin: 0;">
                        <b>Buscar (nombre / RIF):</b>
                        <input name="search" type="text" value="<?php echo e($search); ?>" style="width: 70%; padding: 3px;" placeholder="Nombre o RIF..." oninput="buscarTiempoReal()">
                    </form>
                    <script>
                        let timerBusqueda;
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($puedeGestionar): ?>
                                <div style="display: inline-flex; align-items: center; gap: 4px;">
                                    ...
                                    <form method="POST" action="<?php echo e(route('comunidades.destroy', $c->id)); ?>" style="display: inline; margin: 0;"
                                        ...
                                        <button type="submit" class="cm-btn cm-btn-danger cm-btn-sm" data-ajax-delete data-delete-name="<?php echo e($c->nombre); ?>">Eliminar</button>
                                    </form>
                                </div>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Emanuel\Desktop\Sistemax\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views/comunidades/index.blade.php ENDPATH**/ ?>