<?php $__env->startSection('title', 'Objetivos de Investigación'); ?>
<?php $__env->startSection('header', 'Gestión de Objetivos de la Investigación'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="margin-bottom: 15px; display: flex; align-items: center;">
        <form method="GET" action="<?php echo e(route('objetivos-investigacion')); ?>" style="display: inline-flex; align-items: center;" id="searchForm">
            <b>Buscar Objetivo:</b>
        ...
        <button type="button" onclick="window.location='<?php echo e(route('objetivos-investigacion.create')); ?>'"
                        ...
                        <tr
                            ...
                            <td align="center">
                                <div style="display: inline-flex; align-items: center; gap: 4px;">
                                    <button type="button"
                                        onclick="window.location='<?php echo e(route('objetivos-investigacion.edit', $item->id)); ?>'"
                                        title="Editar" class="cm-btn cm-btn-secondary cm-btn-sm">Editar</button>
                                    <button type="button"
                                        data-ajax-toggle="<?php echo e(route('objetivos-investigacion.toggle', $item->id)); ?>" data-toggle-name="<?php echo e($item->nombre); ?>"
                                    ...
                                    <form action="<?php echo e(route('objetivos-investigacion.destroy', $item->id)); ?>" method="POST"
                                        style="display: inline; margin: 0;"
                                        >
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?><button type="submit" title="Eliminar" class="cm-btn cm-btn-danger cm-btn-sm" data-ajax-delete data-delete-name="<?php echo e($item->nombre); ?>">Eliminar</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\objetivo_investigacion\index.blade.php ENDPATH**/ ?>