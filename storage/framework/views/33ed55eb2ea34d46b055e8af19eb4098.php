                            ...
                            <td align="center">
                                <div class="cm-btn-group"
                                    ...
                                    <button type="button" wire:click.prevent="toggleStatus(<?php echo e($item->id); ?>)"
                                        title="<?php echo e($item->estado_logico ? 'Suspender' : 'Activar'); ?>"
                                        class="cm-btn cm-btn-warning cm-btn-sm">
                                        <?php echo e($item->estado_logico ? 'Suspender' : 'Activar'); ?>
                    ...
                    <tbody class="Texto">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $vinculacionRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compCodigo => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr style="background-color: <?php echo e($loop->iteration % 2 == 0 ? '#E0E0E0' : '#FFFFFF'); ?>;"
                                ...
                                <td align="center">
                                    <input type="checkbox" wire:model="vinculacionRows.<?php echo e($compCodigo); ?>.activo" style="width:18px;height:18px;cursor:pointer;">
                                </td>
                                <td style="padding: 6px;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['activo']): ?>
                                        <div style="display:flex;flex-wrap:wrap;gap:6px;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $row['trayectos'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $traCodigo => $traData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <label style="display:flex;align-items:center;gap:4px;background:#f8f8f8;border:1px solid #ddd;border-radius:5px;padding:4px 8px;cursor:pointer;font-size:11px;<?php echo e($traData['selected'] ? 'background:#e8f5e9;border-color:#198754;' : ''); ?>">
                                                    <input type="checkbox"
                                                        wire:click="toggleTrayecto(<?php echo e($compCodigo); ?>, '<?php echo e($traCodigo); ?>')"
                                                        <?php echo e($traData['selected'] ? 'checked' : ''); ?>

                                                        style="cursor:pointer;">
                                                    <span style="font-weight:<?php echo e($traData['selected'] ? 'bold' : 'normal'); ?>;">
                                                        <?php echo e(collect($trayectosVinculacion ?? [])->firstWhere('tra_codigo', $traCodigo)?->tra_nombre ?? $traCodigo); ?>

                                                    </span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($traData['selected']): ?>
                                                        <span style="font-size:10px;color:#555;">Cantidad:</span>
                                                        <input type="number" min="1" max="200"
                                                            wire:change="cambiarCantidadTrayecto(<?php echo e($compCodigo); ?>, '<?php echo e($traCodigo); ?>', $event.target.value)"
                                                            value="<?php echo e($traData['cantidad']); ?>"
                    ...
                    <fieldset style="border: 1px solid #ddd; border-radius: 6px; padding: 12px; margin-bottom: 15px; background: #fafafa;">
                        ...
                        <table width="100%" border="0" cellpadding="4" cellspacing="0" style="font-size: 12px;">
                            <tr>
                                ...
                                <td width="65%">
                                    <input type="text" wire:model.live.debounce.500ms="rows.<?php echo e($index); ?>.nombre"
                                        style="width: 95%; padding: 4px;"
                                        placeholder="Ej: Informe Final...">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($rowsNombreStatus[$index] ?? null) === 'disponible'): ?>
                                        <br><span style="color: #28a745; font-size: 10px;">✓ Nombre disponible</span>
                                    <?php elseif(($rowsNombreStatus[$index] ?? null) === 'no_disponible'): ?>
...
<?php /**PATH C:\Users\Emanuel\Desktop\Sistemax\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views/livewire/componente-manager.blade.php ENDPATH**/ ?>