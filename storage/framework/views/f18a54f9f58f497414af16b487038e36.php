<?php $__env->startSection('title', 'Editar Objetivo de Investigación'); ?>
<?php $__env->startSection('header', 'Editar Objetivo de Investigación'); ?>
...
<?php $__env->startSection('content'); ?>
    <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 20px; background-color: #FFF;">
        ...
        <form action="<?php echo e(route('objetivos-investigacion.update', $item->id)); ?>" method="POST" style="margin: 0;" onsubmit="return validarFormulario(this)">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <tr>
                    ...
                    <td width="70%">
                        <textarea name="descripcion" rows="4" style="width: 90%;" required><?php echo e(old('descripcion', $item->descripcion)); ?></textarea>
                        <span class="obligatorio">*</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\objetivo_investigacion\edit.blade.php ENDPATH**/ ?>