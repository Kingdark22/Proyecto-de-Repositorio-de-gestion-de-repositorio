                ...
                <tr>
                    <td width="50%">
                        ...
                        <input type="text" name="nombre" id="nombreInput"
                            ...
                            class="grp-filter-input <?php $__errorArgs = ['nombre'];
...
unset($__errorArgs, $__bag); ?>" style="width:90%;"
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><br><span style="color:#dc3545;font-size:10px;"><?php echo e($message); ?></span><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <td>
                        ...
                        <div style="display:flex;gap:4px;align-items:center;">
                            ...
                            <div id="comunidadBadge" style="display:<?php echo e($comSel ? 'flex' : 'none'); ?>;align-items:center;gap:6px;background:#f0f7f0;border:1px solid #b8d4b8;border-radius:4px;padding:4px 10px;font-size:12px;flex:1;">
                                <span style="font-weight:bold;"><?php echo e($comSel ? ($comunidades->firstWhere('com_codigo', (int)$comSel)?->com_nombre ?? '') : ''); ?></span>
                            ...
                            <div class="grp-search-wrapper" id="comunidadSearchWrapper" style="flex:1;display:<?php echo e($comSel ? 'none' : 'block'); ?>;">
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOMContentLoaded, lapsoPreseleccionado=<?php echo e($lapsoPreseleccionado ?? ''); ?>, editingMode=' + editingMode);
    <?php if(isset($grupo)): ?>
