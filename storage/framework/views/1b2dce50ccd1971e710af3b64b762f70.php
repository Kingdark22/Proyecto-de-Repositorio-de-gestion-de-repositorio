...
<select wire:model="tituloSeleccionado" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('titulo-vinculacion-select', get_defined_vars()); ?>wire:key="titulo-vinculacion-select" style="width:100%;padding:10px 12px;border:2px solid #8b0000;border-radius:6px;font-size:15px;box-sizing:border-box; color: #000000 !important; background-color: #ffffff !important; opacity: 1 !important; visibility: visible !important;">
                            <option value="" style="color: #000000 !important; background-color: #ffffff !important;">Seleccione un título...</option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $titulosDisponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tid => $ttitulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e((string)$tid); ?>" <?php echo e((string)$tid === (string)$tituloSeleccionado ? 'selected' : ''); ?> style="color: #000000 !important; background-color: #ffffff !important;"><?php echo e($ttitulo); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <option value="nuevo" <?php echo e($tituloSeleccionado === 'nuevo' ? 'selected' : ''); ?> style="color: #000000 !important; background-color: #ffffff !important;">[ + Crear nuevo título ]</option>
                        </select>
                    </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pasoActual === 2): ?>
                    ...
                    <?php else: ?>
                        <div style="margin-bottom:12px;">
                            <select wire:model.live="comunidadId" style="width:100%;padding:10px 12px;border:2px solid #8b0000;border-radius:6px;font-size:15px;box-sizing:border-box;background:#fff; color: #000000 !important; background-color: #ffffff !important; opacity: 1 !important; visibility: visible !important;">
                                <option value="" style="color: #000000 !important; background-color: #ffffff !important;">Seleccione una comunidad...</option>
            ...
            <div style="background:#fff;border-radius:10px;padding:24px;max-width:480px;width:92%;box-shadow:0 8px 32px rgba(0,0,0,0.2);">
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <div style="margin-top:8px;display:flex;gap:16px;">
                        <label style="display:flex;align-items:center;gap:6px;font-size:14px;cursor:pointer;padding:6px 14px;border:2px solid <?php echo e($tipoReporte === 'titulo' ? '#8b0000' : '#ddd'); ?>;border-radius:8px;background:<?php echo e($tipoReporte === 'titulo' ? '#fff0f0' : '#fafafa'); ?>;transition:all 0.2s;">
                            <input type="radio" wire:model="tipoReporte" value="titulo" style="accent-color:#8b0000;">
                            Por título
                        </label>
                        <label style="display:flex;align-items:center;gap:6px;font-size:14px;cursor:pointer;padding:6px 14px;border:2px solid <?php echo e($tipoReporte === 'lapso' ? '#8b0000' : '#ddd'); ?>;border-radius:8px;background:<?php echo e($tipoReporte === 'lapso' ? '#fff0f0' : '#fafafa'); ?>;transition:all 0.2s;">
...
<?php /**PATH C:\Users\Emanuel\Desktop\Sistemax\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views/livewire/vinculacion-manager.blade.php ENDPATH**/ ?>