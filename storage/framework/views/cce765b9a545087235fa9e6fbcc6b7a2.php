...
<?php $__env->startSection('content'); ?>
    ...
    <form id="proyectoForm" method="POST" action="<?php echo e(route('proyectos.gestion.update', $proyecto->id)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($esSoloLectura): ?>
            <style>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div style="text-align:center;margin-top:20px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($esSoloLectura): ?>
                    ...
                    <a href="<?php echo e(route('proyectos.gestion')); ?>" class="pgm-btn-cancel" style="margin-right:10px;">Volver al listado</a>
                <?php else: ?>
