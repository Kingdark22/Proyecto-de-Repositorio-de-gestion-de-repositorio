<?php $__env->startSection('title', 'Editar Componente'); ?>
<?php $__env->startSection('header', 'Editar Componente'); ?>
...
<?php $__env->startSection('content'); ?>
    <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 20px; background-color: #FFF;">
        ...
        <form method="POST" action="<?php echo e(route('componentes.update', $item->id)); ?>" style="margin: 0;" onsubmit="return validarFormulario(this)">
            <?php echo csrf_field(); ?>
            ...
            <table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size: 12px;">
                <tr>
                    ...
                    <td width="75%">
                                <input name="nombre" type="text" value="<?php echo e(old('nombre', $item->nombre)); ?>"
                    ...
                    <td>
                        <select name="tipo_archivo" style="width: 60%; padding: 6px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Componente::tiposArchivo(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($val); ?>" <?php echo e(old('tipo_archivo', $item->tipo_archivo ?? 'pdf') == $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <tr>
                    ...
                    <td>
                        <input name="tamano_maximo_mb" type="number" value="<?php echo e(old('tamano_maximo_mb', $item->tamano_maximo_mb ?? 10)); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="es_obligatorio" value="1" <?php echo e(old('es_obligatorio', $item->es_obligatorio) ? 'checked' : ''); ?>
            ...
            <div style="text-align: center; margin-top: 20px;">
                ...
                <button type="submit" class="cm-btn cm-btn-primary">Guardar cambios</button>
            </div>
        </form>
    </fieldset>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tu hermana\Downloads\proyecto\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views\componentes\edit.blade.php ENDPATH**/ ?>