<div>
    ...
    <h2 class="titulo" style="margin-bottom: 20px; font-weight: bolder; margin-top: 10px;">Gestión de Objetivos de la
        Investigación</h2>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode === 'list'): ?>
        <div style="margin-bottom: 15px; display: flex; align-items: center;">
            <div>
                <b>Buscar Objetivo:</b>
                <input wire:model.live.debounce.300ms="search" type="text" style="width: 400px; padding: 4px 6px; border-radius: 4px; border: 1px solid #999;" placeholder="Nombre del objetivo...">
            </div>
                            ...
                            <td align="center">
                                <div
                                    ...
                                    <button type="button" wire:click.prevent="delete(<?php echo e($item->id); ?>)"
                                        wire:confirm="¿Estás seguro de eliminar PERMANENTEMENTE este objetivo de investigación?"
    ...
    <?php else: ?>
        <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 20px; background-color: #FFF;">
            <legend style="color: #000; font-weight: bold; font-style: italic; padding: 0 5px;">
                <?php echo e($editingId ? 'Editar Objetivo' : 'Registrar Objetivo'); ?>
...
<?php /**PATH C:\Users\Emanuel\Desktop\Sistemax\Proyecto-de-Repositorio-de-gestion-de-repositorio\resources\views/livewire/objetivo-investigacion-manager.blade.php ENDPATH**/ ?>