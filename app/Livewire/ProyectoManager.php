...
class ProyectoManager extends Component
{
    ...
    public function mount(ProyectoGestionService $gestion): void
    {
        ...
        $this->comunidades = $gestion->comunidadesOrdenadas();
    ...
    public function updatedBuscarComunidad(): void
    {
        ...
        $this->comunidadesEncontradas = \App\Models\Comunidad::where('nombre', 'like', "%{$q}%")
            ->orWhere('rif', 'like', "%{$q}%")
            ->orderBy('nombre')
            ->get();
    }
    ...
    {
        $this->comunidad_id = (string) $id;
        $comunidad = \App\Models\Comunidad::find($id);
        $this->comunidadNombreGrupo = $comunidad?->nombre;
