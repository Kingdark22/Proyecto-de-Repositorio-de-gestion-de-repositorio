...
@section('title', 'Editar Tipo de Investigación')
@section('header', 'Editar Tipo de Investigación')
        ...
        <form method="POST" action="{{ route('tipos-investigacion.update', $item->id) }}" style="margin: 0;" onsubmit="return validarFormulario(this)">
            ...
            <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top: 15px;">
                <tr>
                    ...
                    <td width="70%">
                                <input name="nombre" type="text" value="{{ old('nombre', $item->nombre) }}" required style="width: 90%;" oninput="validarNombre(this)" data-check-url="/tipos-investigacion/check-nombre">
