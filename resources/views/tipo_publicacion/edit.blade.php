...
@section('title', 'Editar Tipo de Publicación')
@section('header', 'Editar Tipo de Publicación')
    ...
    <form method="POST" action="{{ route('tipos-publicacion.update', $item->id) }}" style="margin: 0;" onsubmit="return validarFormulario(this)">
        ...
        <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top: 15px;">
            <tr>
                ...
                <td width="65%">
                                <input type="text" name="nombre" value="{{ old('nombre', $item->nombre) }}" required style="width: 90%;" oninput="validarNombre(this)" data-check-url="/tipos-publicacion/check-nombre">
            ...
            <tr>
                ...
                <td width="65%">
                    <label style="display: flex; align-items: center; gap: 5px;">
                        <input type="checkbox" name="mencion_honorifica" value="1" {{ old('mencion_honorifica', $item->mencion_honorifica) ? 'checked' : '' }}>
