...
@section('content')
    <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 20px; background-color: #FFF;">
        <legend style="color: #000; font-weight: bold; font-style: italic; padding: 0 5px;">Registrar comunidad</legend>
        ...
        <form method="POST" action="{{ route('comunidades.store') }}" style="margin: 0;">
            @csrf
                ...
                <tr>
                    <td width="50%" style="vertical-align: top; padding: 0 4px 10px 0;">
                        <div style="display: flex; align-items: flex-start; gap: 6px;">
                            ...
                            <div style="flex: 1;">
                                <input name="nombre" type="text" value="{{ old('nombre') }}" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;" required>
                            ...
                            <div style="flex: 1;">
                                <div style="display: flex; gap: 5px; align-items: center;">
                                    <select name="rif_letra" style="padding: 4px 6px; border: 1px solid #ccc; border-radius: 4px; background: #fff; font-size: 11px; width: 48px;">
                                        ...
                                        <option value="E" {{ old('rif_letra') == 'E' ? 'selected' : '' }}>E</option>
                ...
                <tr>
                    <td style="vertical-align: top; padding: 0 4px 10px 0;">
                        <div style="display: flex; align-items: flex-start; gap: 6px;">
                            ...
                            <div style="flex: 1;">
                                <input name="correo" type="email" value="{{ old('correo') }}" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;" placeholder="ejemplo@gmail.com">
                                <div style="font-size:10px; color:#888; margin-top:2px;">(opcional)</div>
                        ...
                        <div style="display: flex; align-items: flex-start; gap: 6px;">
                            ...
                            <div style="flex: 1;">
                                <div style="display: flex; gap: 5px; align-items: center;">
                                    ...
                                    <input name="numero_telefono" type="text" value="{{ old('numero_telefono') }}" style="flex: 1; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;" placeholder="XXX-XXXX">
                                </div>
                                <div style="font-size:10px; color:#888; margin-top:2px;">(opcional)</div>
