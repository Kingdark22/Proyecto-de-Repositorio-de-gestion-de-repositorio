...
@section('content')
    ...
    <div style="margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; gap: 20px;">
        <form method="GET" action="{{ route('metodologia-investigacion') }}" style="display: inline-flex; align-items: center; gap: 6px;" id="searchForm">
            ...
            <input name="search" type="text" value="{{ $search }}" style="width: 400px; padding: 4px 6px; border-radius: 4px; border: 1px solid #999;" placeholder="Nombre de la metodología..." oninput="buscarConDebounce(this)">
        </form>
                        ...
                        <tr
                            ...
                            <td align="center">
                                <div style="display: inline-flex; align-items: center; gap: 4px;">
                                    ...
                                    <button type="button" data-ajax-toggle="{{ route('metodologia-investigacion.toggle', $item->id) }}" data-toggle-name="{{ $item->nombre }}"
                                    ...
                                    <form action="{{ route('metodologia-investigacion.destroy', $item->id) }}" method="POST" style="display: inline;" >
                                        @csrf
                                        @method('DELETE')
