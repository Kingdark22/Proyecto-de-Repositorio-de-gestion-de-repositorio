...
<div>
    <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 20px; background-color: #FFF;">
        <legend style="color: #000; font-weight: bold; font-style: italic; padding: 0 5px;">Editar Metodolog&iacute;a</legend>

        <form method="POST" action="{{ route('metodologia-investigacion.update', $item->id) }}" style="margin: 0;">
            @csrf
            @method('PUT')
            <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top: 15px;">
                <tr>
                    ...
                    <td width="70%">
                        <input name="nombre" type="text" value="{{ old('nombre', $item->nombre) }}" style="width: 90%;" required>
