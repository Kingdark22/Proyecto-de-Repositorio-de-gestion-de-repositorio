...
@section('header', 'Editar Componente')
        ...
        <form method="POST" action="{{ route('componentes.update', $item->id) }}" style="margin: 0;" onsubmit="return validarFormulario(this)">
            ...
            <table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size: 12px;">
                ...
                <tr>
                    ...
                    <td>
                        <input name="tamano_maximo_mb" type="number" value="{{ old('tamano_maximo_mb', $item->tamano_maximo_mb ?? 10) }}"
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="es_obligatorio" value="1" {{ old('es_obligatorio', $item->es_obligatorio) ? 'checked' : '' }}
