            ...
            <table width="100%" border="1" cellpadding="5" cellspacing="0"
                ...
                <thead>
                    <tr style="background-color: #8bb2b7; color: #000; font-weight: bold;">
                        <th width="5%">N&deg;</th>
                        <th width="25%">Nombre del Componente</th>
                        <th width="15%">Tipo Archivo</th>
                        <th width="10%">Tama&ntilde;o M&aacute;x.</th>
                        <th width="10%">Obligatorio</th>
                        <th width="10%">Estatus</th>
                        <th width="25%">Configurar</th>
                    </tr>
                </thead>
                <tbody class="Texto">
            ...
            <form wire:submit="save" style="margin: 0;">
                <div style="margin-top: 10px;">
                    <div style="font-size:12px;color:#666;margin-bottom:10px;">
                        Los componentes son <b>globales</b> (no asociados a un PNF espec&iacute;fico).<br>
                        Cada componente define el <b>tipo de archivo</b> y el <b>tama&ntilde;o m&aacute;ximo</b> permitido al subir documentos.
                    </div>
                    <table width="100%" border="1" cellpadding="5" cellspacing="0"
                        ...
                        <thead style="background-color: #f0f0f0;">
                            <tr>
                                ...
                                <th width="20%">Tipo de Archivo</th>
                                <th width="15%">Tama&ntilde;o M&aacute;x. (MB)</th>
                                <th width="10%">Obligatorio</th>
                        ...
                        <tbody>
                            @foreach ($rows as $index => $row)
                                <tr>
                                    ...
                                    <td>
                                        <select wire:model="rows.{{ $index }}.tipo_archivo" style="width: 100%; padding: 4px;">
